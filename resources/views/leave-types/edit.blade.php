                            ...
                            <div>
                                ...
                                <select id="gender" name="gender" class="form-select">
                                    ...
                                    @foreach($genders as $gender)
                                        <option value="{{ $gender->value }}" @selected(old('gender', $leaveType->gender?->value) === $gender->value)>
                                            {{ $gender->value }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                <label class="checkbox-label">
                                    ...
                                    <input type="checkbox" name="isActive" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" @checked(old('isActive', $leaveType->isActive))>
                            ...
                            <div>
                                <label class="checkbox-label">
                                    ...
                                    <input type="checkbox" name="isPaid" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" @checked(old('isPaid', $leaveType->isPaid))>
                            ...
                            <div>
                                <label class="checkbox-label">
                                    ...
                                    <input type="checkbox" name="requiresDocument" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" @checked(old('requiresDocument', $leaveType->requiresDocument))>
