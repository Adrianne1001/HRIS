                            ...
                            <div>
                                ...
                                <select id="maritalStatus" name="maritalStatus" class="form-select" required>
                                    ...
                                    @foreach($maritalStatuses as $status)
                                        <option value="{{ $status->value }}" @selected(old('maritalStatus', $employee->maritalStatus->value) === $status->value)>
                                            {{ $status->value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="department" name="department" class="form-select" required>
                                    ...
                                    @foreach($departments as $department)
                                        <option value="{{ $department->value }}" @selected(old('department', $employee->department->value) === $department->value)>
                                            {{ $department->value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="jobTitle" name="jobTitle" class="form-select" required>
                                    ...
                                    @foreach($positions as $position)
                                        <option value="{{ $position->value }}" @selected(old('jobTitle', $employee->jobTitle->value) === $position->value)>
                                            {{ $position->value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="employmentStatus" name="employmentStatus" class="form-select" required>
                                    ...
                                    @foreach($employmentStatuses as $status)
                                        <option value="{{ $status->value }}" @selected(old('employmentStatus', $employee->employmentStatus->value) === $status->value)>
                                            {{ $status->value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <select id="employmentType" name="employmentType" class="form-select" required>
                                    ...
                                    @foreach($employmentTypes as $type)
                                        <option value="{{ $type->value }}" @selected(old('employmentType', $employee->employmentType->value) === $type->value)>
                                            {{ $type->value }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="md:col-span-3">
                                ...
                                <select id="workScheduleID" name="workScheduleID" class="form-select">
                                    ...
                                    @foreach($workSchedules as $schedule)
                                        <option value="{{ $schedule->id }}" @selected(old('workScheduleID', $employee->workScheduleID) == $schedule->id)>
                                            {{ $schedule->name }}
